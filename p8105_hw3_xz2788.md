...
<img src="p8105_hw3_xz2788_files/figure-markdown_github/plot_ailse-4.png" width="90%" />
...
<img src="p8105_hw3_xz2788_files/figure-markdown_github/two_panel_plot-1.png" width="90%" />

Comments: From the hex plot of temperature, we can see that the highest density is in the middle when max temperature is around 5ºC while the minimum temperature is around 0ºC and also the max temperature is around 25ºC when the minimum is around 15ºC. From the density plot of snowfall, we can see the most frequent amount of snowfall were around 10mm and 25mm, then followed by 50mm and 75mm. The distributions of snowfall over the year were almost the same through years from 1981 to 2010.
